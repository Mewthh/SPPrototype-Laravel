...
<head>
    ...
    <title>News | Samahang Pisika ng Pilipinas</title>
    <meta name="description" content="Read the latest news and announcements from Samahang Pisika ng Pilipinas." />
...
<body>
        ...
        <div class="shell header-inner">
            ...
            <div class="header-nav-group">
                <nav class="desktop-nav" aria-label="Primary navigation">
                    <a href="{{ url('/') }}#news" class="active" aria-current="page">News</a>
                ...
                <details class="mobile-nav">
                    ...
                    <nav class="mobile-nav-panel" aria-label="Mobile navigation">
                        ...
                        <div class="mobile-nav-years" aria-label="Conference year choices">
                            <a href="spp.html?year=2024" class="year-menu-link">SPP2024</a>
                            <a href="spp.html?year=2025" class="year-menu-link">SPP2025</a>
                            <a href="spp.html?year=2026" class="year-menu-link">SPP2026</a>
                        </div>
                    </nav>
                </details>
            </div>
    ...
    <main id="main-content" class="shell">
        <div id="article-root" class="article-page-layout">
